...
testing.exe: main_testing.o area_clienti.o area_gestore.o cliente.o data.o hash.o lezione.o lista_lezioni.o utils.o prenotazione.o orario.o hash_prenotazioni.o report.o
	gcc main_testing.o area_clienti.o area_gestore.o cliente.o data.o hash.o lezione.o lista_lezioni.o utils.o prenotazione.o orario.o hash_prenotazioni.o report.o -o testing.exe

main.o: main.c area_clienti.h area_gestore.h lista_lezioni.h utils.h hash.h hash_prenotazioni.h report.h
	gcc -c main.c

main_testing.o: main_testing.c area_clienti.h area_gestore.h lista_lezioni.h utils.h hash.h hash_prenotazioni.h report.h
	gcc -c main_testing.c
...
clean:
	rm -f *.o palestra.exe testing.exe